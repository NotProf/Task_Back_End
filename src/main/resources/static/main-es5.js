...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppComponentsCompleteRegistrationCompleteRegistrationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJoinJoinComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJoinLoginLoginComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppJoinResistrationResistrationComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCompleteRegistrationCompleteRegistrationComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppComponentsCompleteRegistrationCompleteRegistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CompleteRegistrationComponent", function () {
    ...
    var CompleteRegistrationComponent =
    /*#__PURE__*/
    function () {
      function CompleteRegistrationComponent(activatedRoute, userService, router) {
        _classCallCheck(this, CompleteRegistrationComponent);
      ...
      _createClass(CompleteRegistrationComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {
          var _this = this;
          ...
          this.activatedRoute.params.subscribe(function (param) {
            ...
            _this.userService.activateAccount(param.key).subscribe(function (res) {
              console.log(res);

              if (res) {
                _this.message = 'The Account was successfully activated';
                setTimeout(function () {
                  _this.router.navigateByUrl('join/login');
                }, 3000);
              } else {
                _this.message = 'Invalid URL';
              }
            });
          });
        }
    ...
    CompleteRegistrationComponent.ctorParameters = function () {
      return [{
    ...
    CompleteRegistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-complete-registration',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./complete-registration.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/Components/complete-registration/complete-registration.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./complete-registration.component.css */
      "./src/app/Components/complete-registration/complete-registration.component.css")).default]
  ...
  function srcAppComponentsListListComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ListComponent(modalService, taskService, userService, router, spinner) {
      ...
      _createClass(ListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.taskService.getTasks().subscribe(function (res) {
            ...
            return console.log('Not Authentication');
          });
          this.userService.getUsers().subscribe(function (res) {
            _this2.listUsers = res;
        ...
        value: function save(form) {
          ...
          var task = new _Models_Task__WEBPACK_IMPORTED_MODULE_3__["Task"]();
          var d = form.value.date;
          var date = new Date(d);
        ...
        value: function remove(id) {
          ...
          var conf = confirm('Remove this Task?');

          if (conf) {
            this.taskService.removeTask(id).subscribe(function (res) {
              _this5.tasks = res;
            });
          }
        }
        ...
        key: "details",
        value: function details(task, detail) {
          this.open(detail);
        ...
        value: function update() {
          ...
          this.taskService.updateTask(this.selectedTask).subscribe(function (res) {
            console.log(res);
        ...
        key: "shareTask",
        value: function shareTask(user) {
          var _this7 = this;

          var conf = confirm('Share this task with ' + user.username + '?');
          this.spinner.show();

          if (conf) {
            this.taskService.shareTask(this.selectedTask.id, user.id).subscribe(function (res) {
              if (res) {
                _this7.ngOnInit();
        ...
        value: function removeCurrent() {
          ...
          this.listUsers = this.listUsers.filter(function (user) {
  ...
  function srcAppServicesTaskServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function TaskService(httpClient) {
        ...
        this.httpClient = httpClient; // url = 'http://localhost:8080';
      ...
      _createClass(TaskService, [{
        ...
        value: function addTask(task) {
          return this.httpClient.post("".concat(this.url, "/addTask"), task, {
            headers: this.header
          });
        }
      }, {
        ...
        value: function getTasks() {
          return this.httpClient.get("".concat(this.url, "/getTasks"), {
            headers: this.header
          });
        }
      }, {
        ...
        value: function removeTask(id) {
          return this.httpClient.post("".concat(this.url, "/removeTask"), id, {
            headers: this.header
          });
        }
      }, {
        ...
        value: function updateTask(task) {
          return this.httpClient.post("".concat(this.url, "/updateTask"), task, {
            headers: this.header
          });
        }
      }, {
        key: "shareTask",
        value: function shareTask(task, userId) {
          return this.httpClient.post("".concat(this.url, "/shareTask/").concat(task), userId, {
            headers: this.header
          });
        }
      }]);
  ...
  function srcAppServicesUserServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function UserService(httpClient) {
        ...
        this.authorization = false; // url = 'http://localhost:8080';
      ...
      _createClass(UserService, [{
        ...
        value: function login(user) {
          return this.httpClient.post("".concat(this.url, "/login"), user, {
            observe: 'response'
          });
        }
      }, {
        ...
        value: function registration(user) {
          return this.httpClient.post("".concat(this.url, "/registration"), user);
        }
      }, {
        key: "check",
        value: function check() {
          return this.httpClient.get("".concat(this.url, "/check"), {
            headers: this.header
          });
        }
      }, {
        key: "activateAccount",
        value: function activateAccount(key) {
          return this.httpClient.get("".concat(this.url, "/activate/").concat(key));
        }
      }, {
        key: "getUsers",
        value: function getUsers() {
          return this.httpClient.get("".concat(this.url, "/getUsers"), {
            headers: this.header
          });
        }
      }, {
        ...
        value: function checkUsername(name) {
          return this.httpClient.post("".concat(this.url, "/checkUsername"), name);
        }
      }]);
    ...
    function () {
      ...
      _createClass(AppComponent, [{
        ...
        value: function ngOnInit() {
          ...
          this.userService.check().subscribe(function (res) {
            _this8.userService.authorization = res;
          }, function (error) {
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _join_join_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./join/join.component */
    "./src/app/join/join.component.ts");
    /* harmony import */


    var _join_login_login_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./join/login/login.component */
    "./src/app/join/login/login.component.ts");
    /* harmony import */


    var _join_resistration_resistration_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./join/resistration/resistration.component */
    ...
    var _Components_list_list_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
    /*! ./Components/list/list.component */
    "./src/app/Components/list/list.component.ts");
    /* harmony import */


    var _Components_complete_registration_complete_registration_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
    /*! ./Components/complete-registration/complete-registration.component */
    "./src/app/Components/complete-registration/complete-registration.component.ts");
    /* harmony import */


    var _Components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
    ...
    var routes = [{
      path: 'join',
      component: _join_join_component__WEBPACK_IMPORTED_MODULE_4__["JoinComponent"],
      children: [{
        path: 'login',
        component: _join_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"]
      }, {
        path: 'registration',
        component: _join_resistration_resistration_component__WEBPACK_IMPORTED_MODULE_6__["ResistrationComponent"]
      }]
    }, {
      path: '',
      component: _Components_list_list_component__WEBPACK_IMPORTED_MODULE_10__["ListComponent"]
    }, {
      path: 'complete-register/:key',
      component: _Components_complete_registration_complete_registration_component__WEBPACK_IMPORTED_MODULE_11__["CompleteRegistrationComponent"]
    }, {
      path: 'add',
      component: _Components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_12__["AddTaskComponent"]
    }];
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"], _join_join_component__WEBPACK_IMPORTED_MODULE_4__["JoinComponent"], _join_login_login_component__WEBPACK_IMPORTED_MODULE_5__["LoginComponent"], _join_resistration_resistration_component__WEBPACK_IMPORTED_MODULE_6__["ResistrationComponent"], _Components_list_list_component__WEBPACK_IMPORTED_MODULE_10__["ListComponent"], _Components_complete_registration_complete_registration_component__WEBPACK_IMPORTED_MODULE_11__["CompleteRegistrationComponent"], _Components_add_task_add_task_component__WEBPACK_IMPORTED_MODULE_12__["AddTaskComponent"]],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_8__["RouterModule"].forRoot(routes), _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClientModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_13__["NgbModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_13__["NgbAlertModule"], ngx_spinner__WEBPACK_IMPORTED_MODULE_15__["NgxSpinnerModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_16__["BrowserAnimationsModule"]],
  ...
  /***/
  function srcAppJoinJoinComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppJoinJoinComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    JoinComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/join/join.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./join.component.css */
      "./src/app/join/join.component.css")).default]
    })], JoinComponent);
    /***/
  },
  ...
  /***/
  function srcAppJoinLoginLoginComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppJoinLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
      ...
      _createClass(LoginComponent, [{
        ...
        value: function Login(form) {
          ...
          this.userService.login(form.value).subscribe(function (res) {
            console.log(res);
            _this9.userService.authorization = true;
            localStorage.setItem('Authorization', res.headers.get('Authorization'));
            localStorage.setItem('CurrentUser', res.headers.get('CurrentUser')); // this.router.navigateByUrl('/');

            location.href = '/';
          }, function (error) {
            _this9.message = 'ERROR! Incorrect data or not activated account';
          });
        }
      }]);
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      ...
      "./node_modules/raw-loader/dist/cjs.js!./src/app/join/login/login.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./login.component.css */
      "./src/app/join/login/login.component.css")).default]
    })], LoginComponent);
    /***/
  },
  ...
  /***/
  function srcAppJoinResistrationResistrationComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppJoinResistrationResistrationComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "ResistrationComponent", function () {
    ...
    var ResistrationComponent =
    /*#__PURE__*/
    function () {
      function ResistrationComponent(userService, spinner) {
        _classCallCheck(this, ResistrationComponent);
      ...
      _createClass(ResistrationComponent, [{
        key: "ngOnInit",
        value: function ngOnInit() {}
      }, {
        key: "register",
        value: function register(form) {
          ...
          this.spinner.show();
          var user = form.value;
          this.userService.checkUsername(user.username).subscribe(function (check) {
            if (check) {
              _this10.userService.registration(user).subscribe(function (res) {
                console.log(res);

                if (res) {
                  _this10.message = 'Your account has been created. Check your email';
                }

                _this10.spinner.hide();
              }, function (error) {
                _this10.message = 'Error, Try again';
              ...
              _this10.message = 'Username already exist';
    ...
    ResistrationComponent.ctorParameters = function () {
      return [{
        type: _Services_user_service__WEBPACK_IMPORTED_MODULE_2__["UserService"]
      }, {
    ...
    ResistrationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-resistration',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./resistration.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/join/resistration/resistration.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./resistration.component.css */
      "./src/app/join/resistration/resistration.component.css")).default]
